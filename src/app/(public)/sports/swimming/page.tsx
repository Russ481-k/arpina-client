...
export default function ParticipantsPage() {
  ...
  return (
    <PageContainer>
      {/* <InfoTopBox
        title="수영장 대관안내 Futsal"
        titleHighlight="수영장 대관안내"
        description="부산도시공사 아르피나에서는 시민들의 건강과 편익 증진을 도모 하고자 수영장 대관을 다음과 같이 운영하고 있습니다."
        images={images}
